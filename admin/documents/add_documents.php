...
<script>
	jQuery(document).ready(function($){
	"use strict";	
	$("#tag_name1").blur(function(){
	$("#tag_name1").removeClass("ui-autocomplete-loading");
	});
	});
</script>
<?php 	
        ...
        <form name="documents_form" action="" method="post" class="form-horizontal" id="documents_form" enctype='multipart/form-data'>	
			...
			<div class="form-group">		
				...
				<option value=""><?php esc_html_e('Select Documents Type','lawyer_mgt');?></option>
						 <?php if($edit)
						$documents_type = esc_attr($document_result->type);					
					else 
						 $documents_type = ""; 
					 ?>
			...
			<div class="form-group">
				...
				<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12 has-feedback">			
					...
					<?php 
					 if($edit)
						$case_name = esc_attr($document_result->case_id);				
					else 
						$case_name = "";
					...
					<div id="cartificate_entrys">
						...
						<div class="form-group">	
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<a  class="status_read btn btn-default" href="<?php print esc_url(content_url().'/uploads/document_upload/'.esc_attr($document_result->document_url)); ?>" record_id="<?php echo esc_attr($document_result->id);?>">
								<i class="fa fa-download"></i><?php echo esc_attr($document_result->document_url);?></a>
							</div>
						</div>
						<div class="form-group">	
							...
							<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">	      
								<input type="text" name="tag_name" id="tag_name1" class="form-control tages_add ui-autocomplete-input validate[custom[onlyLetterSp]],maxSize[50]] margin_cause" maxlength="50" placeholder="<?php esc_html_e('Enter New Tages','lawyer_mgt');?>" autocomplete="off" value="" row="1">	
							</div>
						...
						<div class="form-group">	
							<div class="list_tag_name1 offset-lg-2 col-lg-4 offset-md-2 col-md-4 offset-sm-2 col-sm-4 col-xs-12" row="1">						
								...
								foreach ($tag_name as $retrive_data)
								{
									...
									{
									?>
										<div class="added_tag tagging_name"><?php echo esc_html($retrive_data);?>
			...
			?>
				<div id="cartificate_div">	
					<div id="cartificate_entry1" class="cartificate_entry" row="1">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
							<input type="text"  name="cartificate_name[]" id="title_value" placeholder="<?php esc_html_e('Enter Documents Title','lawyer_mgt');?>" class="form-control validate[required,custom[onlyLetter_specialcharacter],maxSize[50]] margin_cause"/>
						</div>
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
						<input type="file" name="cartificate[]" class="form-control margin_cause file_validation input-file validate[required]">				
						</div>					
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">	      
							<input type="text" autocomplete="off" maxlength="50" name="tag_name" id="tag_name1" class="form-control tages_add ui-autocomplete-input validate[custom[onlyLetter_specialcharacter],maxSize[50]] margin_cause"  placeholder="<?php esc_html_e('Enter New Tages','lawyer_mgt');?>"  value="" row="1">	
