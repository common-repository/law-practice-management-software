		...
		<form name="task_form" action="" method="post" class="form-horizontal" id="task_form" enctype='multipart/form-data'>	
			...
			<div class="form-group">
				...
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 has-feedback">
					...
					value="<?php if($edt){ echo MJ_lawmgt_getdate_in_input_box(esc_attr($casedata->due_date));}elseif(isset($_POST['due_date'])){ echo MJ_lawmgt_getdate_in_input_box($_POST['due_date']); } ?>" readonly>
			...
			<div class="form-group">
				...
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 has-feedback">
					<textarea id="description" class="form-control validate[custom[address_description_validation]]" type="text" placeholder="<?php esc_html_e('Enter Description','lawyer_mgt');?>" maxlength="150" value="" name="description"><?php if($edt){ echo esc_textarea($casedata->description); } ?></textarea>
				</div>
			</div>					
				...
				<div class="header">						
					...
					<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label " for="priority"><?php esc_html_e('Priority','lawyer_mgt');?></label>
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 has-feedback">
							...
							<!--<option value="-1" <?php if($edt && $casedata->priority=='-1') { print ' selected'; }?>><?php esc_html_e('Select Priority','lawyer_mgt');?></option>-->				
					   ...
					   <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label " for="phone_work"><?php esc_html_e('Repeat Until','lawyer_mgt');?></label>
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 has-feedback">
